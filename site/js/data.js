/**
 * TeachingCareer — demo data for this HTML/CSS/JS stage.
 *
 * This is placeholder data only, used to make the frontend testable
 * (vacancy slider, filters, profile/vacancy detail pages, blog). None of
 * this is real data, and none of it is stored anywhere permanent — it is
 * defined here in the browser so every page can read the same list. The
 * real versions of these lists will come from the WordPress database once
 * this frontend is converted into the theme.
 */
var TC_DATA = {
	...
	vacancies: [
		{
			...
			teachersNeeded: 1,
			description: 'Beacon School is looking for an experienced Mathematics teacher for O Level classes. The role covers Grade 9 and 10 Mathematics with a focus on exam preparation.',
			active: true
		},
		{
			id: 'v2',
	...
	schools: [
		{
			...
			about: 'Beacon School is a registered institution offering O Level education with a focus on Mathematics, Physics, and English.'
		},
		{
			id: 's2',
			...
			about: 'Greenwood Academy offers Cambridge curriculum education from Grade 1 to Grade 10.'
		},
		{
			id: 's3',
			...
			about: 'City Grammar School is known for its strong A Level Science program.'
		}
	],
