...
const CARDS: StatCard[] = [
  ...
  { label: 'Candidate Applications', value: (s) => s.candidateApplications, icon: InboxIcon, to: '/admin/candidate-applications' },
  { label: 'School Registrations', value: (s) => s.schoolRegistrations, icon: InboxIcon, to: '/admin/school-registrations' },
